...
{
private:
	friend class FalconController;
	virtual void callback(FalconController* Controller) = 0;
};
...
public:
	...
	static FalconController* getSingleton();
	...
	FalconVect3 getPositionArray();
	Annwvyn::AnnVect3 getPosition();
	...
	void setCallback(HapticCallback* object)
	{
