...
FalconController::FalconVect3 FalconController::getPositionArray()
{
...
Annwvyn::AnnVect3 FalconController::getPosition()
{
	getPositionArray();
	return Annwvyn::AnnVect3(position[0], position[1], position[2]);
}
